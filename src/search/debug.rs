...
pub struct SearchDebugStats {
    ...
    pub lmr_unchanged_reductions: u64,
    pub lmr_increased_reductions: u64,
    pub lmr_decreased_reductions: u64,
    pub lmr_zero_reductions: u64,
    pub lmr_saturated_reductions: u64,
    pub qnodes: u64,
