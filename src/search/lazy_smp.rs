...
pub(super) fn select_lazy_smp_result(results: &[ThreadResult]) -> Option<&ThreadResult> {
...
fn run_lazy_smp_worker(
    ...
    let my_moves = lazy_smp_worker_root_moves(&job.root_moves, thread_id, job.num_threads);
